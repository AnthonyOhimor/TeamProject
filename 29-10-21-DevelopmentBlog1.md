...
Sstrengths, weaknesses, and preferences discussed amongst team members to give an idea of who will be working on which element of the project. Shortly followed by brainstorming about the type of game which is to be developed. 
...
Mechanics? Clicking mechanics. Alternating clicking sports games, speed of clicks used in other existing mini-clip games. Holding key mechanics, which are time-based. Further exploration and experimentation are underway via Gameplay research.
